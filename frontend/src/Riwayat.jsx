...
const consultationSummary = {
  ...
  obat:
    "Diberikan resep bronkodilator dan antibiotik selama 7 hari.",
  rangkuman:
    ...
    <div className="index-page">
      ...
      >
        ...
        >
          ...
          >
            Pantau dan Kelola <span style={{ color: '#3b60e4' }}>Riwayat Kesehatan</span> Anda dengan Mudah
          </h1>
          ...
          >
            Ini adalah{' '}
            <span style={{ color: '#4db6ac' }}>Bagian Riwayat Kesehatan</span> di OxeMed —  
            tempat Anda dapat melihat dan memantau rekam medis serta rangkuman konsultasi kesehatan pernapasan secara <em>real-time</em>.
          </p>
          ...
          >
            Dengan data yang lengkap dan tampilan yang mudah dipahami, Anda dapat mengikuti perkembangan kesehatan Anda dengan lebih percaya diri,  
            serta memperoleh informasi penting dari tenaga medis kapan saja diperlukan.
          </p>
        </section>
        ...
        >
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label htmlFor="date-picker" style={{ fontWeight: '600', marginRight: '1rem' }}>
              Pilih Tanggal:
            </label>
            <DatePicker
              id="date-picker"
          ...
          <div style={{ width: '100%', height: 300 }}>
            <ResponsiveContainer>
              <LineChart data={dailyData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
                ...
                />
                <Line yAxisId="left" type="monotone" dataKey="spO2" stroke="#8884d8" activeDot={{ r: 8 }} />
        ...
        >
          ...
          <p>
            <strong>Penjelasan Diagnosis:</strong> Pasien didiagnosa Hipertensi dengan gejala tambahan pusing berulang dan mual ringan. Hipertensi adalah kondisi tekanan darah tinggi yang dapat menyebabkan berbagai masalah kesehatan jika tidak ditangani.
          </p>
          <p>
            <strong>Penjelasan Obat:</strong> Pasien diresepkan Amlodipine 5 mg, yang merupakan obat untuk menurunkan tekanan darah. Diminum 1 tablet setiap pagi. Selain itu, diresepkan juga Vitamin B1 untuk membantu mengatasi keluhan pusing.
          </p>
          <p>
            <strong>Rangkuman:</strong> Pasien Budi Santoso (45 tahun) mengeluhkan pusing yang terkadang disertai mual. Dokter mendiagnosa hipertensi dan memberikan resep Amlodipine 5 mg dan Vitamin B1. Dokter menyarankan untuk periksa tekanan darah secara berkala, mengurangi konsumsi garam, dan melakukan kontrol ulang 2 minggu lagi.
          </p>
        </section>
