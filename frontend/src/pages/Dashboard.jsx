    ...
    <div className="index-page">
      ...
      >
        <div className="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
          ...
          <button className="btn-getstarted" onClick={openLoginModal}>
            Login
          </button>
        </div>
      </header>
        ...
        <section className="hero-section">
          <div className="hero-content">
            <h1>
              ...
              <span className="highlight">Health </span>and{" "}
              <span className="highlight">Care</span>
            </h1>
            <p className="subheading">
              Track your respiratory health instantly and connect with medical
              experts anytime.
            </p>
            <p className="description">
              OxeMed offers real-time health tracking, enabling you to monitor
              your respiratory health and connect instantly with medical
              professionals for timely consultations. Take control of your
              health today and prevent complications before they arise.
            </p>
        ...
        <div className="modal-overlay" onClick={closeModals}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              ...
              <button className="link-button" onClick={openSignupModal}>
                Sign Up
              </button>
            </p>
        ...
        <div className="modal-overlay" onClick={closeModals}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              ...
              <button className="link-button" onClick={openLoginModal}>
                Login
              </button>
            </p>
            <button className="modal-close-btn" onClick={closeModals}>
